...
proc ddr3_p0_get_input_clk_id { pll_output_node_id } {
	if {[ddr3_p0_is_node_type_pll_clk $pll_output_node_id]} {
		...
		ddr3_p0_traverse_fanin_up_to_depth $pll_output_node_id ddr3_p0_is_node_type_pll_inclk clock results_array 1
		if {[array size results_array] == 1} {
			...
			ddr3_p0_traverse_fanin_up_to_depth $pll_inclk_id ddr3_p0_is_node_type_pin clock results_array 3
			if {[array size results_array] == 1} {
...
proc ddr3_p0_get_output_clock_id { ddio_output_pin_list pin_type msg_list_name {max_search_depth 13} } {
...
proc ddr3_p0_get_output_clock_clkbuf_id { ddio_output_pin_list pin_type msg_list_name {max_search_depth 13} } {
	upvar 1 $msg_list_name msg_list
	set output_clock_id -1
...
proc ddr3_p0_traverse_to_ddio_out_periphery_clock {pin msg_list_name} {
	upvar 1 $msg_list_name msg_list
	set result ""
	if {$pin != ""} {
...
proc ddr3_p0_get_dqs_phase_setting { dqs_pins } {
...
proc ddr3_p0_get_dqs_phase { dqs_pins } {
	...
	set dll_length 8
	set dqs_phase_setting [ ddr3_p0_get_dqs_phase_setting $dqs_pins ]

	if { $dqs_phase_setting != $::GLOBAL_ddr3_p0_dqs_delay_chain_length } {
		...
		post_message -type critical_warning "   Parameter value: $::GLOBAL_ddr3_p0_dqs_delay_chain_length"
...
proc ddr3_p0_dump_static_pin_map { ddr_db_par filename } {
	...
	foreach instname $instnames {
		...
		ddr3_p0_static_map_expand_string $FH pins valid_fifo_wrdata_reg 
		ddr3_p0_static_map_expand_string $FH pins valid_fifo_rddata_reg
