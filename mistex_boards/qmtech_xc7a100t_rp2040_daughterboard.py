...
class Gamecore(Module):
    def __init__(self, platform, soc, sys_clk_freq, delay_hps_miso) -> None:
        ...
        sys_top = Instance("sys_top",
            ...
            # CD pin from microSD card for RP2040 Daughterboard is pulled up without FPGA connection
...
def main(core):
    ...
    platform = qmtech_artix7_fgg676.Platform(with_rp2040_daughterboard=True)
