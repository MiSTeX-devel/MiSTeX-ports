...
def main(coredir, core):
    ...
    if toolchain is None:
        toolchain = "vivado"
    platform = qmtech_artix7_fgg676.Platform(kgates=200, with_daughterboard=False, toolchain=toolchain)
    ...
    soc = BaseSoC(platform, core_name=core, fpga_name="XC7A200T", toolchain=toolchain)
    builder = Builder(soc,
        build_backend="litex",
