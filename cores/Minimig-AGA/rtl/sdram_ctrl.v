...
reg oe;
assign sd_data = oe ? sd_data_reg : 16'hZZZZ;
...
reg reset;
always @(posedge sysclk) begin : reset_block
	reg [7:0] reset_cnt;
...
always @ (posedge sysclk) begin : write_block
	reg  [1:0] write_state;
...
always @ (posedge sysclk) begin : sdata_block
	reg [15:0] sdata_chip;
...
//// sdram state ////
reg [3:0] sdram_state;
always @ (posedge sysclk) begin : state_block
	reg old_7m;
...
always @ (posedge sysclk) begin : fsm_block
	reg        cas_sd_cas;
	reg        cas_sd_we;
	reg  [1:0] cas_dqm;
	reg [15:0] datawr;
